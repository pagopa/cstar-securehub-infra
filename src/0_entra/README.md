...
|------|-------------|------|---------|:--------:|
| <a name="input_argocd_entra_groups_allowed_extra"></a> [argocd\_entra\_groups\_allowed\_extra](#input\_argocd\_entra\_groups\_allowed\_extra) | Definizione della variabile per i nomi dei gruppi Entra ID | `list(string)` | n/a | yes |
