...
| <a name="input_eventhub_namespace_name"></a> [eventhub\_namespace\_name](#input\_eventhub\_namespace\_name) | Name of the Event Hub Namespace used for Kafka connection. | `string` | `""` | no |
