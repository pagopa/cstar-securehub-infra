...
module "secrets" {
  ...
  secrets = compact([
    ...
    var.env == "uat" ? "hype-client-id" : null,
    var.env == "uat" ? "hype-client-secret" : null,
    var.env == "uat" ? "hype-tpp-id" : null,
    var.env == "uat" ? "fucino-client-id" : null,
    var.env == "uat" ? "fucino-client-secret" : null,
    var.env == "uat" ? "fucino-tpp-id" : null,
