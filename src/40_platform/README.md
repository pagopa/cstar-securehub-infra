...
| Name | Source | Version |
|------|--------|---------|
| <a name="module___v4__"></a> [\_\_v4\_\_](#module\_\_\_v4\_\_) | git::https://github.com/pagopa/terraform-azurerm-v4.git | c57b246c5167fb782ba3123be499be313bbe69ff |
...
| <a name="module_data_factory"></a> [data\_factory](#module\_data\_factory) | ./.terraform/modules/__v4__/data_factory | n/a |
...
| <a name="input_argocd_terraform_module_tier"></a> [argocd\_terraform\_module\_tier](#input\_argocd\_terraform\_module\_tier) | Tier for argocd terraform module | `string` | n/a | yes |
...
| <a name="input_influxdb2_helm"></a> [influxdb2\_helm](#input\_influxdb2\_helm) | influxdb2 helm chart configuration | <pre>object({<br/>    chart_version = string,<br/>    image = object({<br/>      name = string,<br/>      tag  = string<br/>    })<br/>    tolerations = optional(list(any), [])<br/>    affinity    = optional(map(any), {})<br/>  })</pre> | n/a | yes |
