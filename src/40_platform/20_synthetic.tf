...
# module "synthetic_function" {
#   source     = "./.terraform/modules/__v4__/monitoring_function"
#   depends_on = [azurerm_application_insights.synthetic_application_insights]
#
#   legacy = false
#
#   location            = var.location
...
#   job_settings = {
#     cron_scheduling              = "*/5 * * * *"
#     container_app_environment_id = data.azurerm_container_app_environment.synthetic_cae.id
...
#   }
#
#   synthetic_configuration_encoded = templatefile("${path.module}/tpl/synthetic_configuration.json.tpl", {
#     env_name               = var.env,
