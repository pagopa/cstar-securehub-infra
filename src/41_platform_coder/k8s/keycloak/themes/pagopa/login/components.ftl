<#macro header>
    <header class="header">
        ...
        <nav class="header-nav">
            <a href="${properties.headerManualUrl!''}" class="text-dark-light">
                <img alt="" src="${url.resourcesPath}/img/book.png"/>
                Manuale operativo
            </a>
            <a href="${properties.headerSupportUrl!''}" class="text-dark-light">
        ...
        <div class="footer-content">
            <div class="footer-columns">
                ...
                <div class="footer-column">
                    <h2>RISORSE</h2>
                    <ul>
                        <li><a href="${properties.footerPrivacyUrl!''}">Informativa Privacy</a></li>
                        <li><a href="${properties.footerTermsUrl!''}">Termini e Condizioni</a></li>
                ...
                <div class="footer-column">
                    ...
                    <div class="social-icons">
                      <a aria-label="linkedin" href="https://www.linkedin.com/company/pagopa/" target="_blank" rel="noopener noreferrer">
                      ...
                      <a aria-label="x.com" href="https://x.com/pagopa" target="_blank" rel="noopener noreferrer">
                      ...
                      <a aria-label="instagram" href="https://www.instagram.com/pagopaspa/" target="_blank" rel="noopener noreferrer">
                      ...
                      <a aria-label="medium" href="https://medium.com/pagopa-spa" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://form.agid.gov.it/view/9b5c6ed0-bbbb-11f0-a7e5-9bac06d781c9" aria-label="Accessibilità" class="footer-text">Accessibilità</a>
                    <br><br>
