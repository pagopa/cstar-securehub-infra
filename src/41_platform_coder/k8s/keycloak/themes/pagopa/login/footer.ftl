    ...
    <div class="footer-content">
        <div class="footer-columns">
            ...
            <div class="footer-column">
                <h2>RISORSE</h2>
                <ul>
                    <li><a href="https://pari.pagopa.it/esercente/privacy-policy">Informativa Privacy</a></li>
                    <li><a href="https://pari.pagopa.it/esercente/terms-of-service">Termini e Condizioni</a></li>
