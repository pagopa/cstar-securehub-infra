...
| <a name="module_emd_mdc_api_product"></a> [emd\_mdc\_api\_product](#module\_emd\_mdc\_api\_product) | ./.terraform/modules/__v4__/api_management_product | n/a |
| <a name="module_emd_mdc_citizen"></a> [emd\_mdc\_citizen](#module\_emd\_mdc\_citizen) | ./.terraform/modules/__v4__/api_management_api | n/a |
| <a name="module_emd_mdc_tpp_testing"></a> [emd\_mdc\_tpp\_testing](#module\_emd\_mdc\_tpp\_testing) | ./.terraform/modules/__v4__/api_management_api | n/a |
...
| Name | Type |
|------|------|
| [azurerm_api_management_policy_fragment.apim-validate-token-mdc](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/api_management_policy_fragment) | resource |
...
| [kubernetes_config_map.mdc-common](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/config_map) | resource |
...
| [azurerm_eventhub_namespace.eventhub](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/eventhub_namespace) | data source |
...
| <a name="input_enable"></a> [enable](#input\_enable) | Feature flags | `object({})` | `{}` | no |
...
| <a name="input_location_string"></a> [location\_string](#input\_location\_string) | One of Italy North, West Europe | `string` | n/a | yes |
| <a name="input_mdc_issuer_url"></a> [mdc\_issuer\_url](#input\_mdc\_issuer\_url) | MDC issuer url | `string` | n/a | yes |
| <a name="input_mdc_openid_url"></a> [mdc\_openid\_url](#input\_mdc\_openid\_url) | OpenId MIL url | `string` | n/a | yes |
