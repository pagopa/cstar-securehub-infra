...
| <a name="module_tag_config"></a> [tag\_config](#module\_tag\_config) | ../../00_tag_config | n/a |
...
| <a name="input_cidr_idpay_data_storage"></a> [cidr\_idpay\_data\_storage](#input\_cidr\_idpay\_data\_storage) | Storage subnet network address space. | `list(string)` | n/a | yes |
