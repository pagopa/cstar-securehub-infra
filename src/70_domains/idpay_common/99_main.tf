...
module "__v4__" {
  # https://github.com/pagopa/terraform-azurerm-v4/releases/tag/v10.8.0
  source = "git::https://github.com/pagopa/terraform-azurerm-v4.git?ref=fix/idh-output-connection-string"
}
