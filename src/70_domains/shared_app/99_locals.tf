locals {
  ...
  # Workload Identity
  secret_name_workload_identity_client_id            = "${var.domain}-workload-identity-client-id"
  secret_name_workload_identity_service_account_name = "${var.domain}-workload-identity-service-account-name"
