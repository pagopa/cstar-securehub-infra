      ...
      "content": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "jsonData": "[\r\n    {\"value\": \"itn-onboarding-workflow\", \"selected\": true},\r\n    {\"value\": \"itn-payment-io\", \"selected\": true},\r\n    {\"value\": \"itn-qr-code-payment-io\", \"selected\": true},\r\n    {\"value\": \"itn-iban\", \"selected\": true},\r\n    {\"value\": \"itn-timeline\", \"selected\": true},\r\n    {\"value\": \"itn-wallet\", \"selected\": true}\r\n]",
            "timeContext": {
              "durationMs": 0
            },
          ...
          {
            "id": "fa932b9f-995a-4d81-a146-9df8f6b7898e",
            "version": "KqlParameterItem/1.0",
            "name": "itnUsersProduct",
            "type": 1,
            "value": "idpay_itn_api_portal_users_product"
          },
          {
            "id": "804940c5-5ad5-48b1-860b-5c50209b0961",
            "version": "KqlParameterItem/1.0",
            "name": "itnUsersOperation",
            "type": 1,
            "value": "-user-portal"
          },
          {
        ...
        "items": [
          {
            ...
            "content": {
              ...
              "links": [
                ...
                {
                  "id": "a13f3fde-87c4-42a0-b1a8-fb156f232141",
                  "cellValue": "selectedTab",
                  "linkTarget": "parameter",
                  "linkLabel": "OPEX - USERS WEB",
                  "subTarget": "users",
                  "style": "link",
                  "linkIsContextBlade": true
                },
              ...
              "items": [
                ...
                },
                {
                  ...
                  "content": {
                    ...
                    "crossComponentResources": [
                      "/subscriptions/${subscription_id}/resourceGroups/${prefix}-idpay-monitoring-rg/providers/Microsoft.OperationalInsights/workspaces/${prefix}-idpay-law"
                    ],
                          ...
                          "filters": [
                            {
                              ...
                              "operator": 0,
                              "values": [
                                "idpay_itn_api_io_product"
                              ]
                            },
                            {
                              "id": "7",
                              "key": "customDimensions/HTTP Method",
                              "operator": 1,
                              "values": [
                                "OPTIONS"
                              ]
                                      ...
                                      "filters": [
                                        {
                                          ...
                                          "values": [
                                            ...
                                            "initiative",
                                            "initiative_counters",
                                            "initiative_counters_preallocations",
                                            "notification",
                                            "onboarding_citizen",
                                            "onboarding_families",
                                            "payment_instrument",
                    ...
                    "items": [
                          ...
                          "filters": [
                            {
                              ...
                              "operator": 0,
                              "values": [
                                "/realms/merchant-operator/.well-known/openid-configuration",
                                "/realms/merchant-operator/login-actions/authenticate",
                                "/realms/merchant-operator/protocol/openid-connect/auth",
                                "/realms/merchant-operator/protocol/openid-connect/certs",
                                "/realms/merchant-operator/protocol/openid-connect/token",
                                "/realms/merchant-operator/protocol/openid-connect/userinfo"
                              ]
                            }
                          ],
                          "gridSettings": {
                      ...
                      },
                      {
                        ...
                        "content": {
                          ...
                          "title": "Requests Successful True",
                          "showOpenInMe": true,
                          "filters": [
                            {
                              "id": "2",
                      ...
                      },
                      {
                        ...
                        "content": {
                          ...
                          "title": "Requests Successful False",
                          "showOpenInMe": true,
                          "filters": [
                            {
                              "id": "2",
                        ...
                        "name": "Requests Successful False"
                      },
                      {
                        "type": 10,
                        "content": {
                          ...
                          "filters": [
                            {
                              ...
                              "operator": 0,
                              "values": [
                                "/realms/user/protocol/openid-connect/token",
                                "/realms/user/protocol/openid-connect/logout",
                                "/realms/user/protocol/openid-connect/certs",
                                "/realms/user/protocol/openid-connect/auth",
                                "/realms/user/protocol/openid-connect/3p-cookies/step2.html",
                                "/realms/user/protocol/openid-connect/3p-cookies/step1.html",
                                "/realms/user/login-actions/authenticate",
                                "/realms/user/broker/oneid-keycloak/login",
                                "/realms/user/broker/oneid-keycloak/endpoint",
                                "/realms/user/account",
                                "/realms/user/.well-known/openid-configuration"
                              ]
                            }
                          ],
                          "gridSettings": {
          ...
          },
          {
            ...
            "content": {
              ...
              "metricScope": 0,
              "resourceIds": [
                "/subscriptions/${subscription_id}/resourceGroups/${prefix}-core-aks-rg/providers/Microsoft.ContainerService/managedClusters/${prefix}-dev-aks"
              ],
              "timeContextFromParameter": "timeRangeOverall",
              "timeContext": {
                "durationMs": 86400000
