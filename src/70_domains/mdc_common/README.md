...
| <a name="module_cosmos_account"></a> [cosmos\_account](#module\_cosmos\_account) | ./.terraform/modules/__v4__/IDH/cosmosdb_account | n/a |
| <a name="module_cosmosdb_collections"></a> [cosmosdb\_collections](#module\_cosmosdb\_collections) | ./.terraform/modules/__v4__/cosmosdb_mongodb_collection | n/a |
| <a name="module_eventhub_configuration"></a> [eventhub\_configuration](#module\_eventhub\_configuration) | ./.terraform/modules/__v4__/eventhub_configuration | n/a |
...
| Name | Type |
|------|------|
| [azurerm_cosmosdb_mongo_database.mdc](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/cosmosdb_mongo_database) | resource |
...
| [azurerm_key_vault_secret.eventhub_primary_connection_strings](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
| [azurerm_key_vault_secret.redis_secrets](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_secret) | resource |
...
| <a name="input_cidr_subnet_cosmosdb_mdc"></a> [cidr\_subnet\_cosmosdb\_mdc](#input\_cidr\_subnet\_cosmosdb\_mdc) | Cosmos DB address space for mdc. | `list(string)` | n/a | yes |
| <a name="input_cidr_subnet_eventhub_mdc"></a> [cidr\_subnet\_eventhub\_mdc](#input\_cidr\_subnet\_eventhub\_mdc) | Eventhub address space for mdc. | `list(string)` | n/a | yes |
| <a name="input_cidr_subnet_redis_mdc"></a> [cidr\_subnet\_redis\_mdc](#input\_cidr\_subnet\_redis\_mdc) | Azure redis address space for mdc. | `list(string)` | n/a | yes |
| <a name="input_cidr_subnet_storage_mdc"></a> [cidr\_subnet\_storage\_mdc](#input\_cidr\_subnet\_storage\_mdc) | Azure storage DB address space for mdc. | `list(string)` | n/a | yes |
| <a name="input_cosmos_mongo_db_mdc_params"></a> [cosmos\_mongo\_db\_mdc\_params](#input\_cosmos\_mongo\_db\_mdc\_params) | n/a | <pre>object({<br/>    enable_serverless  = bool<br/>    enable_autoscaling = bool<br/>    throughput         = number<br/>    max_throughput     = number<br/>  })</pre> | n/a | yes |
...
| <a name="input_dns_zone_prefix"></a> [dns\_zone\_prefix](#input\_dns\_zone\_prefix) | The mdc DNS subdomain. | `string` | `null` | no |
...
| <a name="input_location"></a> [location](#input\_location) | One of italynorth, westeurope | `string` | n/a | yes |
| <a name="input_location_short"></a> [location\_short](#input\_location\_short) | One of itn, weu | `string` | n/a | yes |
