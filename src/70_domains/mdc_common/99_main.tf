...
module "__v4__" {
  # https://github.com/pagopa/terraform-azurerm-v4/releases/tag/v10.4.0
  source = "git::https://github.com/pagopa/terraform-azurerm-v4.git?ref=1803944f83242d65229f2c46fce3e7728ba272eb"
}
